...
public class Config
{
    ...
    public int column_index_max_target_size_kb = 256*1024; // downsample if we're > 2x this value
    public int column_index_max_target_index_objects = 50000; // downsample if we're > 2x this value
