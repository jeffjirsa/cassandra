...
public class ReverseTimestampResolver extends CellResolver implements ConflictResolver
{
    public final String className = "org.apache.cassandra.db.resolvers.ReverseTimestampResolver";
