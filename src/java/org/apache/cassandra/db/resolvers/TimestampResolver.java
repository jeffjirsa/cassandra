...
public class TimestampResolver extends CellResolver implements Resolver
{
    ...
    protected TimestampResolver()
    {
        className = "org.apache.cassandra.db.resolvers.TimestampResolver";
    }
    ...
    {
        logger.warn("TimestampResolver::writeTombstone()");
    ...
    {
        logger.warn("TimestampResolver::diff(cell merged, Cell cell");
    ...
    {
        logger.warn("TimestampResolver::reconcile ");
    ...
    {
        logger.warn(String.format("TimestampResolver::reconcile(%s, %s, %s)", c1, c2, nowInSec));
        if (c1 == null)
    ...
    public long reconcileComplex(Clustering clustering,
                                        ...
                                        SecondaryIndexManager.Updater indexUpdater)
    {
        logger.warn("TimestampResolver::reconcileComplex()");
    ...
    {
        logger.warn(String.format("TimestampResolver.getNext(%s)", iterator));
    ...
    {
        return "TimestampResolver("+className+")";
    }
