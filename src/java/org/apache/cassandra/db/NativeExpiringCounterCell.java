...
public class NativeExpiringCounterCell extends NativeCell implements ExpiringCounterCell
{
    private static final long SIZE = ObjectSizes.measure(new NativeExpiringCounterCell());

    private NativeExpiringCounterCell()
    {}

    public NativeExpiringCounterCell(NativeAllocator allocator, OpOrder.Group writeOp, ExpiringCounterCell copyOf)
    {
    ...
    {
        return new BufferExpiringCounterCell(copy(metadata, allocator), allocator.clone(value()), timestamp(), timestampOfLastDelete(), getTimeToLive(), getLocalDeletionTime());
    }
