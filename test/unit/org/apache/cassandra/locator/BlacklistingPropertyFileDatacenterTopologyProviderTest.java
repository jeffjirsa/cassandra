...
/**
 * Unit tests for {@link org.apache.cassandra.locator.BlacklistingPropertyFileDatacenterTopologyProvider}
 * */
public class BlacklistingPropertyFileDatacenterTopologyProviderTest
{

    @Test
    public void testBaseConfiguration() throws Exception
    {
        IDatacenterTopologyProvider datacenterTopologyProvider = new BlacklistingPropertyFileDatacenterTopologyProvider();
        ...
        assert(dcTopologyProvider instanceof BlacklistingPropertyFileDatacenterTopologyProvider);
